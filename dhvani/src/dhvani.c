...
#else
			dhvani_info
			    ("Dhvani is compiled without soundtouch support. Default pitch will be used.\n");
#endif
...
#else
			dhvani_info
			    ("Dhvani is compiled without soundtouch support. Default speed will be used.\n");
#endif
...
#else
				dhvani_info
				    ("Dhvani is compiled without ogg voribis support. Defaul sound format(wav) will be used.\n");
				options->output_file_format = DHVANI_WAV_FORMAT;
#endif
