...
/* $Header: /home/santhosh/dhvani-cvsbackup/dhvani/gsm/src/toast.c,v 1.3 2007-12-15 12:47:30 smc_dhvani Exp $ */
...
static void version P0()
{
	printf( "%s 1.0, version %s\n",
		progname,
		"$Id: toast.c,v 1.3 2007-12-15 12:47:30 smc_dhvani Exp $" );
}
