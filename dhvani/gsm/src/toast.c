...
/* $Header: /home/santhosh/dhvani-cvsbackup/dhvani/gsm/src/toast.c,v 1.1.1.1 2001-09-12 18:25:00 oazim Exp $ */
...
static void version P0()
{
	printf( "%s 1.0, version %s\n",
		progname,
		"$Id: toast.c,v 1.1.1.1 2001-09-12 18:25:00 oazim Exp $" );
}
