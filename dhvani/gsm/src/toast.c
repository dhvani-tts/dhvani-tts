...
/* $Header: /home/santhosh/dhvani-cvsbackup/dhvani/gsm/src/toast.c,v 1.2 2007-03-01 10:36:33 smc_dhvani Exp $ */
...
static void version P0()
{
	printf( "%s 1.0, version %s\n",
		progname,
		"$Id: toast.c,v 1.2 2007-03-01 10:36:33 smc_dhvani Exp $" );
}
